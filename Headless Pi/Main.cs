    ...
    public partial class Main : System.Windows.Forms.Form
    {
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            if (Load_Drive()) // Find SD Card
            {
                ...
                Load_Networks();     // Load known wireless networks
            }
            else
            {
                Application.Exit();
        ...
        private void Load_Country()
        {
            ...
            combCountry.SelectedValue = country.Substring(country.LastIndexOf("-") + 1);
        }
        ...
        /// <summary>
        /// Gets wireless lan list from netsh
        /// </summary>
        private void Load_Networks()
        {
            Process proc = new Process
            {
                ...
                {
                    FileName = "netsh.exe",
                    Arguments = "wlan show profiles", //"wlan show profile Bohica key=clear",
            ...
            while (!proc.StandardOutput.EndOfStream)
            {
                ...
                if (line.Contains("All User Profile"))
                {
                    ...
                    lbNetworks.Items.Add(line);
                }
            }
        }

        /// <summary>
        /// Get wireless network information from netsh
        /// </summary>
        private void GetNetworkInfo()
        {
            txtSSID.Text = lbNetworks.SelectedItem.ToString();
            txtPassword.Text = "";
            ...
            Process proc = new Process
            {
                ...
                {
                    FileName = "netsh.exe",
                    Arguments = "wlan show profile " + txtSSID.Text + " key=clear",
                    UseShellExecute = false,
                    RedirectStandardOutput = true,
                    CreateNoWindow = true
                }
            ...
            while (!proc.StandardOutput.EndOfStream)
            {
                ...
                {
                    txtSSID.Text = line.Substring(line.LastIndexOf(":") + 1).Trim().Replace("\"", "");
                }
                else if (line.Contains("Key Content"))
                {
                    txtPassword.Text = line.Substring(line.LastIndexOf(":") + 1).Trim();
                }
            }
        }
        ...
        private void btnWriteSupplicant_Click(object sender, EventArgs e)
        {
            ...
            fs.Close();
            string msg = "Your supplicant file has been written.";
            string title = "Headless Pi: File Written";
            MessageBoxButtons buttons = MessageBoxButtons.OK;
            MessageBoxIcon icon = MessageBoxIcon.Information;
            MessageBox.Show(msg, title, buttons, icon);
        }
        ...
        /// <summary>
        /// Populate SSID and Password from local setup
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void lbNetworks_SelectedIndexChanged(object sender, EventArgs e)
        {
            GetNetworkInfo();
        }
    }
